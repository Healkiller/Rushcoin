...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About RushCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>RushCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The RushCoin developers", Q_NULLPTR));
